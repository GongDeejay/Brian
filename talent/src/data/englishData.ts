...
export const ENGLISH_ARCHETYPES: Record<
  string,
  {
    title: string;
    subtitle: string;
...
> = {
  architect: {
    ...
    coreNature: "You possess an exceptional gift for systemic modeling and causal deconstruction. Faced with messy information, you instinctively identify causal chains, construct taxonomies, and architect scalable, self-consistent frameworks.",
    specificKnowledge: "Dimensional abstraction of underlying logic. While others fight fires in fragmented symptoms, you immediately spot the structural root cause and engineer an automated pipeline.",
    signSignature: {
      success: "Unrivaled reliability and elegance when designing complex workflows and diagnosing root causes.",
      ...
      need: "A deep sense of internal psychological harmony when all cogs in a system mesh flawlessly.",
    },
  },
  catalyst: {
    ...
    coreNature: "Your superpower lies in deep social acuity and interpersonal intuition. You perceive unspoken tensions, unlock latent motivation in peers, and build trust-rich psychological safety in groups.",
    specificKnowledge: "High-bandwidth emotional decoding and catalytic communication. You sense what people truly crave and how to rally diverse personalities toward a shared dream.",
    signSignature: {
      success: "High psychological safety, accelerated team alignment, and profound mentorship outcomes.",
      instinct: "Instinctively attuned to micro-expressions, shifts in energy, and psychological safety in any room.",
      grow: "Rapidly grasps human dynamics, counseling skills, group psychology, and storytelling.",
      need: "Profound fulfillment when seeing someone transform or flourish under your encouragement.",
    },
  },
  artisan: {
    title: "Meticulous Artisan & Craft Perfectionist",
    subtitle: "The Meticulous Artisan",
    tagline: "Relentless pursuit of micro-perfection, turning execution into a high art form",
    coreNature: "You possess extraordinary tedium tolerance and craftsmanship patience. Where others settle for 'good enough', your uncompromising eye detects microscopic imbalances and polishes every millimeter.",
    specificKnowledge: "An acute aesthetic and functional sensitivity to microscopic details that creates an unbreachable moat of quality.",
    signSignature: {
      success: "Delivering outputs with flawless finish, unshakeable robustness, and watchmaker precision.",
      instinct: "Instinctive irritation with careless shortcuts, sloppy formatting, or clumsy interfaces.",
      grow: "Unusually steep mastery of intricate tools, domain precision standards, and specialized instruments.",
      need: "Quiet, sublime peace of mind when holding an artifact polished to the highest state of integrity.",
    },
  },
  strategist: {
    title: "Visionary Strategist & Synthesis Scout",
    subtitle: "The Visionary Strategist",
    tagline: "Connecting distant dots, navigating complex terrain with eagle-eyed foresight",
    coreNature: "You excel at pattern recognition, meta-trends, and second-order thinking. You see three moves ahead, effortlessly linking insights across biology, economics, tech, and human nature.",
    specificKnowledge: "Cross-domain associative synthesis. You translate disparate signals into a coherent strategic thesis before the market realizes what is happening.",
    signSignature: {
      success: "Accurate directional foresight and high-leverage decision making under extreme uncertainty.",
      instinct: "Subconscious scanning for macro shifts, anomalies, and structural leverage points.",
      grow: "Vast intellectual appetite; rapid synthesis of books, whitepapers, and historical cycles.",
      need: "Thrilling validation when your non-consensus prediction manifests into reality.",
    },
  },
  storyteller: {
    title: "Insightful Storyteller & Resonant Orator",
    subtitle: "The Resonant Storyteller",
    tagline: "Translating esoteric abstraction into gripping narratives that move minds",
    coreNature: "You are a master of linguistic nuance, vivid metaphor, and narrative momentum. You possess the rare ability to unpack complex, dry concepts into emotionally resonant, unforgettable stories.",
    specificKnowledge: "High-efficiency conceptual translation and meme engineering. You make the esoteric accessible and compelling.",
    signSignature: {
      success: "Effortless audience engagement, viral meme diffusion, and rapid mindshare capture.",
      instinct: "Instinctively framing every experience or dry data point as an unfolding hero's journey.",
      grow: "Hyper-sensitive ear for rhetorical cadence, cognitive hooks, and emotional resonance.",
      need: "Electric joy when witnessing an audience have a collective breakthrough epiphany.",
    },
  },
  synthesizer: {
    title: "Cross-Disciplinary Synthesizer & Polymath",
    subtitle: "The Polymath Synthesizer",
    tagline: "Building bridges between silos, birthing novel paradigms at the intersections",
    coreNature: "You are an omnivorous learner and boundary-crosser. You refuse to stay inside a single narrow discipline, extracting models from disparate worlds to pioneer novel hybrid methodologies.",
    specificKnowledge: "Skill Stacking and cross-pollination. Combining two 80th-percentile skills to create a top 1% hybrid edge.",
    signSignature: {
      success: "Breaking longstanding creative blockades by transplanting analogies from unrelated fields.",
      instinct: "Restless intellectual curiosity that rebels against over-specialized tunnel vision.",
      grow: "Rapid speed in acquiring 80/20 foundational mental models of unfamiliar domains.",
      need: "Pure delight when discovering an unexpected isomorphism between two completely distant fields.",
    },
  },
  operator: {
    title: "Decisive Operator & Pragmatic Executer",
    subtitle: "The Pragmatic Operator",
    tagline: "Ruthless prioritization and bias for action, transforming ideas into reality",
    coreNature: "You thrive on momentum, rapid iteration, and concrete tangible impact. Theories and abstract discussions are meaningless until converted into a working MVP and real traction.",
    specificKnowledge: "Action-oriented reality testing and obstacle demolition. You find the path of highest leverage with zero fluff.",
    signSignature: {
      success: "Consistently delivering results ahead of schedule while bypassing organizational friction.",
      instinct: "Impatience with prolonged debate; an immediate impulse to prototype and test.",
      grow: "Sharp operational instincts sharpened through hands-on combat and empirical feedback.",
      need: "Profound satisfaction seeing an abstract idea running live in the real world.",
    },
  },
  inquisitor: {
    title: "Deep Inquisitor & First-Principles Researcher",
    subtitle: "The Deep Inquisitor",
    tagline: "Tracing truth to its primary source, unmasking dogma with rigorous intellectual honesty",
    coreNature: "You refuse to accept second-hand hearsay or superficial explanations. You insist on reading the primary sources, inspecting the raw data, and verifying the fundamental axioms yourself.",
    specificKnowledge: "Intellectual endurance and truth-seeking rigor. You untangle foundational fallacies that everyone else took for granted.",
    signSignature: {
      success: "Uncovering critical overlooked errors and grounding decisions in rock-solid empirical bedrock.",
      instinct: "Immediate skepticism toward consensus buzzwords and unproven dogmas.",
      grow: "Extraordinary patience with dense historical texts, technical documentation, and raw datasets.",
      need: "Exquisite intellectual serenity when reaching the unshakeable bedrock of truth.",
    },
  },
};
